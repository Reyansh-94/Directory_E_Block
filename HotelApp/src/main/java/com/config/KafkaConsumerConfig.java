...
import com.consumerapp.entity.Order;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Order> consumerFactory() {
        ...
        kafkaConfigProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringSerializer.class);
        kafkaConfigProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

       
        // Create and return the DefaultKafkaConsumerFactory
